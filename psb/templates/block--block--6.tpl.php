...
<div class="tab-content">
	<div id="attorney" class="tab-pane fade in active">
		<form action="">
			<input type="search" name="Last name" placeholder="Last name"> 	<input type="search" name="Postcode" placeholder="Suburb or Postcode (optional)"> <input type="submit" value="Submit">
		</form> 
	</div>
	<div id="incorp" class="tab-pane fade">
		<form action="">
			<input type="search" name="Firm name" placeholder="Firm name"> <input type="search" name="Postcode" placeholder="Suburb or Postcode (optional)"> <input type="submit" value="Submit">
		</form> 
	</div>
</div>
